...
// ── Voice recording (mic → WebM → Whisper → inputText) ──────
// MediaRecorder captures WebM/Opus. Taki transcodes to WAV via ffmpeg
// before sending to Whisper (vLLM can't decode Opus).
